      ...
      <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl animate-fade-in">
           <p className="text-brand-gold font-medium tracking-[0.4em] uppercase mb-4 text-sm">
...
<p className="text-gray-500 text-sm">{f.desc}</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
            {categories.map((cat, idx) => (
              <button 
                ...
                className="group relative overflow-hidden rounded-3xl aspect-[3/4] bg-white shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-gray-100"
              >
                <img 
                  src={cat.image} 
                  alt={cat.name} 
  ...
  <h3 className="text-white font-display text-xl font-bold tracking-wide">
    {cat.name}
  </h3>
  ...
  <span className="inline-block mt-4 text-white text-sm border border-brand-gold px-4 py-2 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500">
    Explore Collection →
  </span>
</div>
              </button>
